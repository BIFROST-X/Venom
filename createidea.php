...
<nav class="navbar navbar-expand-md bg-indo navbar-dark navbar-fixed-top navbar-custom" style="margin-top: .5%;">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar" >
   <ul class="nav navbar-nav">
    ...
    <li><a href="idea.php" class="" style="color:navy;">STUDENT<!--sup><span class="badge badge-primary">! </span></sup --></a></li>
    <li><a href="idea2.php" class="">RESEARCHER<!--sup><span class="badge badge-primary">! </span></sup --></a></li>
...
<br>
          ...
          <form  method="POST">
            <input type="text" name="e1" placeholder="College Name *" required="" ><br>
            <input type="text" name="e2" placeholder=" Student Name*" required=""><br>
            ...
            <input type="text" name="e9" placeholder="Github Repo / Link*" required=""><br>
