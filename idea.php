...
$collection4=$db->selectCollection("research");
...
<nav class="navbar navbar-expand-md bg-indo navbar-dark navbar-fixed-top navbar-custom" style="margin-top: .5%;">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar" >
   <ul class="nav navbar-nav">
    <li><a href="idea.php" class="" >STUDENT<!--sup><span class="badge badge-secondary">! </span></sup --></a></li>
    <li><a href="idea2.php" class="">RESEARCHER</a></li>
    <li><a href="idea3.php" class="">BLOG</a></li>
 ...
 <h1 style="margin-top: 1%;">IDEAS POSTED By <font color="firebrick"> STUDENTS </font></h1>
 
 <a href="createidea.php" class="btn btn-light" style="margin-left: 88%;margin-top: -4%;">POST AN IDEA</a>
...
<i style="font-size: 2em;"><?php echo $vari['idesc'] ?></i><br>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <ul type="disc" style="font-weight:bold;text-align: justify;font-size: 1.5em;">
          <i>College / Institute Name : <font color="firebrick"><?php echo $vari['cname'] ?> </font></i><br>
        <i>Student Name : <font color="firebrick"><?php echo $vari['sname']?></font></i><br>
        <i>Contact Number: <font color="firebrick"><?php echo $vari['loc'] ?></font></i><br> 
              <i>Student Email : <font color="firebrick"><?php echo $vari['em'] ?></font></i> <br> 
              <i>Resource Link : <font color="firebrick"><?php echo $vari['link'] ?></font></i><br>
