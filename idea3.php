...
$collectionb=$db->createCollection("blog");
?>
  <html>
...
<nav class="navbar navbar-expand-md bg-indo navbar-dark navbar-fixed-top navbar-custom" style="margin-top: .5%;">
 ...
 <h1 style="margin-top: 1%;">Experiences or <font color="firebrick"> Blogs </font></h1>
 
 <a href="createidea3.php" class="btn btn-light" style="margin-left: 88%;margin-top: -4%;">Post</a>

    </header>
    <div class="container">

      <?php 
      $var=$collectionb->find();
      foreach($var as $vari)
      {
...
<i style="font-size: 2em;text-align:justify;"><?php echo $vari['idesc'] ?></i><br>
 ...
 <div class="modal fade" id="myModal1">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <i>User Name : <font color="firebrick"><?php echo $vari['sname']?></font></i><br>
