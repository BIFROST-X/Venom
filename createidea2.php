...
<nav class="navbar navbar-expand-md bg-indo navbar-dark navbar-fixed-top navbar-custom" style="margin-top: .5%;">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar" >
   <ul class="nav navbar-nav">
    ...
    <li><a href="idea2.php" class="" style="color: navy;">RESEARCHER</a></li>
...
<br>
          ...
          <h3 class="modal-title">SHARE YOUR IDEA</h3>
         
          <form  method="POST">
            <input type="text" name="e1" placeholder="Organization Name *" required="" ><br>
            <input type="text" name="e2" placeholder="Full Name*" required=""><br>
            <input type="text" name="e3" placeholder="IDEA TITLE" required=""><br>
            <input type="text" name="e4" placeholder="IDEA Description *" required=""><br>
            ...
            <input type="text" name="e9" placeholder="Looking for" required=""><br>
            <input type="text" name="e10" placeholder="Enter Sample Test Question" required=""><br>
...
<?php
if(isset($_POST["cf"])){
$fest=array('oname'=>$_POST['e1'],'name'=>$_POST['e2'],'it'=>$_POST['e3'],'idesc'=>$_POST['e4'],'pdate'=>$_POST['e5'],'loc'=>$_POST['e6'],'pho'=>$_POST['e7'],'em'=>$_POST['e8'],'lf'=>$_POST['e9'],'test'=>$_POST['e10']);
$db->research->insert($fest);
echo '<script> 
    alert("Successfull");
     window.location="idea2.php";
    </script>';
    $idean = $_POST['e3'];
    $ema = $_POST['e8'];
